...
print(f"The total value of the loans is: {total_value}")
...
present_value = future_value / (1 + discount_rate/compounding_periods) ** remaining_months

fair_value = present_value
rounded_fair_value = round((fair_value), 2)
print(f"The Fair Value of the Loans is: ${rounded_fair_value}")
...
def loan_present_value (future_value, remaining_months, annual_discount_rate):
    present_v = future_value / ((1 + annual_discount_rate/12) ** remaining_months)
    return present_v


# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
present_value = loan_present_value(1000, 12, 0.2)
